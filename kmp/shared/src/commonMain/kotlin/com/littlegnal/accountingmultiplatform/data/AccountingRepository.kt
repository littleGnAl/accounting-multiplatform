...
import AccountingSerialization
import GetGroupingMonthTotalAmountSerialization
import GetMonthTotalAmountSerialization
    ...
    coroutineScope {
      async(runCoroutineDispatcher) {
        accountingDB.accountingDBQueries
            .totalExpensesOfDay(timeMilliseconds.toString(), timeMilliseconds.toString())
            .executeAsOne()
            .total!!
      }
    }
